...
from bottle import route, get, request, run, template, static_file, app
try:
...
@route('/web_exec_c.py')
def c_exec():
  #print request.query.raw_input_json
  return run_cpp_backend.clogger('./',request.query.user_script,'c',request.query.raw_input_json)

@route('/web_exec_cpp.py')
def cpp_exec():
  return run_cpp_backend.clogger('./',request.query.user_script,'cpp',request.query.raw_input_json)
